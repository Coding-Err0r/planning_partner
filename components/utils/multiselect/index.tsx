        ...
        >
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex w-full p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-gray-200",
                className
              )}
            >
                      ...
                      return (
                        <Badge
                          ...
                          className={cn(
                            ...
                            "bg-white text-black border border-gray-200 hover:bg-[#00e084] hover:text-white",
